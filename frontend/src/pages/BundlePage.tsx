  ...
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      ...
      <BundlePatchDialog
        ...
        onApplied={() => {
          // A patch can rename the bundle (when its name was still
          // autogenerated), which moves the slug — and the URL. The old slug in
          // the address bar no longer resolves, so refetching it in place would
          // 404 and nothing would reload. Drop its cache and jump to the stable
          // UUID; the canonical-slug redirect (the effect above) then lands us on
          // the new slug with freshly fetched data.
